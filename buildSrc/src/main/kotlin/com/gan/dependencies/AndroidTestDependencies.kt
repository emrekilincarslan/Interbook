...
object AndroidTestDependencies {
    ...
    const val navigation_testing =
        "androidx.navigation:navigation-testing:${Versions.nav_components}"
    const val hilt_testing = "com.google.dagger:hilt-android-testing:${Versions.hilt_version}"
    const val dexmaker_mockito =
        "com.linkedin.dexmaker:dexmaker-mockito:${Versions.dexmaker_mokito}"
}